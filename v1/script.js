...
const CATEGORIES = [
  ...
  { name: "entertainment", color: "#db" },
  { name: "health", color: "#14b8a6" },
  { name: "history", color: "#f97316" },
  { name: "news", color: "#8b5cf6" },
  // הוסף כאן קטגוריות נוספות בהתאם למה שקיים ב-Supabase
];
...
async function loadFacts() {
  const res = await fetch(
    "https://lvvsmpgwjxkuptpssbto.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2dnNtcGd3anhrdXB0cHNzYnRvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MjUxMTgxNDQsImV4cCI6MjA0MDY5NDE0NH0.TIlOPW0ctyeFxqDkn4W0AWQTXdb6Fn4VTae21gNfIzc",
      },
    }
  );
